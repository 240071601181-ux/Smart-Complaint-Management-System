              ...
              >
                <Card className="tab-panel">
                  <div className="card-header">
                    <div><span className="section-kicker">SESSION</span><h2>Sign out?</h2></div>
                  </div>
                  <p className="lede">You will be signed out of the MadVoice operations workspace on this device.</p>
